...
I2CdevT<SoftWire,uint16_t> i2cdev16(softWire);  // A I2Cdev template specialization with 16 bit register addresses
I2CdevT<SoftWire,uint8_t> i2cdev8(softWire);    // A I2Cdev template specialization with  8 bit register addresses
